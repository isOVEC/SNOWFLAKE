...
- **Ресурсы**: 🪵 дерево, 🪨 камень, 🪙 золото и 🍖 еда. Дерево, камень и золото добываются ударами по деревьям, скалам и золотым жилам,
  падают с монстров и боссов. Еду дают **коровы** — мирные стада на лугах и в лесах (не нападают, убегают, если их бить) — и немного кабаны.
...
- **11 зданий**: ратуша (точка возрождения, радиус базы, лимиты, склад), стены, башня лучников, башня магов,
  лесопилка, каменоломня, золотой рудник, **дом крестьян** (нанимает крестьян за еду: они сами рубят деревья и копают камень
  и золото в радиусе базы, носят добычу домой и едят 1 🍖 раз в 15 с; без еды бросают работу и через минуту уходят,
  от врагов убегают), казарма (рыцари, которые ходят за тобой в набег), святилище (лечит),
...
- **Боты**: по умолчанию в мире живут 6 ботов — фармят, строят базы, качаются, эволюционируют и ходят в набеги. Чат только для живых игроков — боты в него не пишут.
...
| **F1–F11** | выбрать здание, ЛКМ — поставить (стены можно «рисовать», зажав ЛКМ; Shift — ставить несколько), Esc/ПКМ — отмена |
