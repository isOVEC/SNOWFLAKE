...
(function (root) {
  ...
  S.SUBCLASSES = {
    ...
    druid: {
      ...
      desc: 'Шипы пробивают и замедляют, регенерация вдвое выше. Умение — зов леса: призывает 2 живых дерева-энта, корни сковывают врагов и лечат своих.',
      desc20: 'Зов леса поднимает 3 могучих энта на 30 секунд, корни держат дольше.',
      hp: 1.25, speed: 1.0, dmg: 0.95, cd: 0.8, ability: { name: 'Зов леса', cd: 12, dmg: 30, radius: 280 },
    },
    holy: {
  ...
  S.ALLY_UNITS = {
    ...
    ent: { name: 'Энт', hp: 260, r: 26, speed: 160, dmg: 19, cd: 1.1 },
